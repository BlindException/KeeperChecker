...
class KeeperController extends Controller
{
    ...
    public function index()
    {
        if (request()) {
            ...
            $client = new Client();
            try {
                $response = $client->request('GET', 'https://fantasysports.yahooapis.com/fantasy/v2/users;use_login=1/games;game_keys=nfl;seasons=2023;//teams;//draftresults;round=9', [
                    'headers' => [
