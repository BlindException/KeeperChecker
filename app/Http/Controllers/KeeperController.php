    ...
    public function index()
    {
        if (request()) {
            ...
            try {
                ...
                $response = $client->request('GET', 'https://fantasysports.yahooapis.com/fantasy/v2/league/423.l.142134/transactions;team_key=423.l.142134.t.7;type=drop', [
                    'headers' => [
            ...
            dd($dropTransactions[10]->players->player);
